...
Extreme VOSS is part of the [community.network](https://galaxy.ansible.com/ui/repo/published/community/network) collection and only supports CLI connections today. This page offers details on how to use `ansible.netcommon.network_cli` on VOSS in Ansible.
...
<tr class="odd">
<td></td>
<td><p>supported: use <code>ansible_become: true</code> with <code>ansible_become_method: enable</code></p></td>
</tr>
<tr class="even">
