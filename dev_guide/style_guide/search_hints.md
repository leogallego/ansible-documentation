...
One word of caution - you do want to limit the size of your headings. A full heading such as <span class="title-ref">How do I write documentation so search engines can find my content?</span> is too long. Search engines would truncate anything over 50 - 60 characters. Long headings would also wrap on smaller devices such as a smart phone.

## Using numbered lists for <span class="title-ref">zero position</span> snippets
