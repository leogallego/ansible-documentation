...
We made several fixes to how we handle keywords and 'inline variables', to avoid conflating the two. Unfortunately these changes mean you must specify whether <span class="title-ref">name</span> is a keyword or a variable when calling roles. If you have playbooks that look like this:
...
See playbooks_tests for more information.
...
These modules may no longer have documentation in the current release. Please see the [Ansible 2.4 module documentation](https://docs.ansible.com/ansible/2.4/list_of_all_modules.html) if you need to know how they worked for porting your playbooks.
...
- Several modules which could deal with symlinks had the default value of their `follow` option changed as part of a feature to [standardize the behavior of follow](https://github.com/ansible/proposals/issues/69):
...
See the module utilities developer guide see developing_module_utilities for more information.
