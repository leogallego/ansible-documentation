...
We suggest you read this page along with [ansible-core Changelog for 2.18](https://github.com/ansible/ansible/blob/stable-2.18/changelogs/CHANGELOG-v2.18.rst) to understand what updates you may need to make.
