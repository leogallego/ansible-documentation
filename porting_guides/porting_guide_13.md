...
We suggest you read this page along with the [Ansible 13 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/13/CHANGELOG-v13.md) to understand what updates you may need to make.
...
- mysql_info - The `users_info` filter does not return the `plugin_auth_string` field anymore. Use the <span class="title-ref">plugin_hash_string</span> return value instead (<https://github.com/ansible-collections/community.mysql/pull/629>).
...
- The deprecated `community.digitalocean` collection has been removed (<https://forum.ansible.com/t/44602>).
- The deprecated `ibm.qradar` collection has been removed (<https://forum.ansible.com/t/44259>).
...
- hash_params function in roles/\_\_init\_\_ is being deprecated as it is not in use.
