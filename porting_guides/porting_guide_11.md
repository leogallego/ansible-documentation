...
We suggest you read this page along with the [Ansible 11 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/11/CHANGELOG-v11.md) to understand what updates you may need to make.
...
- The `cisco.ise` collection is considered unmaintained and will be removed from Ansible 12 if no one starts maintaining it again before Ansible 12. See [Collections Removal Process for unmaintained collections](https://docs.ansible.com/projects/ansible/devel/community/collection_contributors/collection_package_removal.html#unmaintained-collections) for more details, including for how this can be cancelled (<https://forum.ansible.com/t/43367>). After removal, users can still install this collection with `ansible-galaxy collection install cisco.ise`.
...
- The `cisco.asa` collection has been deprecated. It will be removed from Ansible 12 if no one starts maintaining it again before Ansible 12. See [Collections Removal Process for unmaintained collections](https://docs.ansible.com/projects/ansible/devel/community/collection_contributors/collection_package_removal.html#unmaintained-collections) for more details (<https://forum.ansible.com/t/38960>).
...
- zabbix_agent role - Remove support for <span class="title-ref">zabbix_agent_zabbix_alias</span>.
- zabbix_agent role - Remove support for <span class="title-ref">zabbix_get_package</span> variable.
- zabbix_agent role - Remove support for <span class="title-ref">zabbix_sender_package</span> variable.
- zabbix_agent role - Remove support for all <span class="title-ref">zabbix_agent2\_\*</span> variables.
...
- Bumping <span class="title-ref">requires_ansible</span> to <span class="title-ref">\>=2.15.0</span>, since previous ansible-core versions are EoL now.
...
- Bumping <span class="title-ref">requires_ansible</span> to <span class="title-ref">\>=2.15.0</span> due to the end-of-life status of previous <span class="title-ref">ansible-core</span> versions.
...
- Remove deprecated <span class="title-ref">VariableManager.\_get_delegated_vars</span> method (<https://github.com/ansible/ansible/issues/82950>)
...
- removed check and handling of mangled api key in <span class="title-ref">grafana_dashboard</span> lookup
...
- Deprecate <span class="title-ref">grafana_notification_channel</span>. It will be removed in version 3.0.0
