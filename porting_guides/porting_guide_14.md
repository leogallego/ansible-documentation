...
We suggest you read this page along with the [Ansible 14 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/14/CHANGELOG-v14.md) to understand what updates you may need to make.
...
- The awx.awx collection has been removed from Ansible 14. The collection is undergoing a heavy [refactoring](https://forum.ansible.com/t/7404) and currently does not align with the standards for the community package. See [the removal discussion](https://forum.ansible.com/t/44706) for details. Users can still install this collection with `ansible-galaxy collection install awx.awx`.
