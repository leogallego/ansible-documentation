...
Beginning in version 2.20, you can enable argument validation using the play keyword `validate_argspec`. This adds a `validate_argument_spec <ansible.builtin.validate_argument_spec` task following play-level fact gathering. This feature is tech preview.
