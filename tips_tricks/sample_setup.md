...
You can access host variables with a special variable called `hostvars`. See special_variables for a list of these variables. The `hostvars` variable can access only host-specific variables, not group variables.
