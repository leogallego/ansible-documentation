...
See module_contribution for some general guidelines about Ansible module development that may help you craft a good code fix for the bug.
...
> 1.  Fill out the pull request template with all the information you want to mention.
