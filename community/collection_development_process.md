...
Development on collections occurs at the macro and micro levels. Each collection has its own macro development cycle. For more information on the collections development cycle, see contributing_maintained_collections. The micro-level lifecycle of a PR is similar in collections and in `ansible-core`.
...
- the [Ansible Community Working Group](https://forum.ansible.com/tags/c/project/7/community-wg) .
...
We do not merge every PR. See collection_quickstart for tips to make your PR useful, attractive, and merge-worthy.
...
PRs that add a new module or plugin do not necessarily need a changelog fragment. See community_changelogs. Also see changelogs_how_to_format for the precise format changelog fragments should have.
...
**deprecated_features**  
Features that have been deprecated and are scheduled for removal in a future release. Write in the past tense. Include an alternative, where available, for the feature being deprecated. Displayed in both the changelogs and the Porting Guides.
...
**removed_features**  
Features that were previously deprecated and are now removed. Write in the past tense. Include an alternative, where available, for the feature being deprecated. Displayed in both the changelogs and the Porting Guides.
