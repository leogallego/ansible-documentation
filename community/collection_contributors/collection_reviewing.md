...
- If new files are added with the pull request, they follow the coll_licensing_req.
- The changes follow the Ansible documentation standards and the style_guide.
...
- New features have corresponding examples in the examples_block.
- Return values are documented in the return_block.
