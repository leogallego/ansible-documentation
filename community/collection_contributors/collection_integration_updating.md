...
1.  Determine if integration tests for the module exist. If they do not, see collection_creating_integration_tests section.
...
1.  Determine if integration tests for the module exists. If they do not, see collection_creating_integration_tests.
