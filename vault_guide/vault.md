...
\* Encryption with Ansible Vault ONLY protects 'data at rest'. Once the content is decrypted ('data in use'), play and plugin authors are responsible for avoiding any secret disclosure, see no_log for details on hiding output and vault_securing_editor for security considerations on editors you use with Ansible Vault.
