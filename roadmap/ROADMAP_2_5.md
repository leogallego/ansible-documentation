...
- Namespacing fact variables (with a config option) implemented in ansible/ansible PR [\#18445](https://github.com/ansible/ansible/pull/18445). Proposal found in ansible/proposals issue [\#17](https://github.com/ansible/proposals/issues/17).
