...
This release schedule includes dates for the [ansible](https://pypi.org/project/ansible/) package, with a few dates for the [ansible-base](https://pypi.org/project/ansible-base/) package as well. All dates are subject to change. See base_roadmap_2_10 for the most recent updates on ansible-base.
...
We initially were going to have feature freeze on 2020-08-18. We tried this but decided to change course. Instead, we'll enter feature freeze when ansible-2.10.0 beta1 is released.
...
- 2020-08-13: ansible-base 2.10 Release date, see base_roadmap_2_10.
...
Minor releases will stop when Ansible-3 is released. See the Release and Maintenance Page for more information.
